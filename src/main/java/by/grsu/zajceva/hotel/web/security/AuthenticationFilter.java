package by.grsu.zajceva.hotel.web.security;
...
public class AuthenticationFilter implements Filter {
	public static final String USERL_ATTR_NAME = "loggedUser";
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if (!"/login".equals(req.getRequestURI())) {
			...
			Object user = session.getAttribute(USERL_ATTR_NAME);
			if (user == null || !(user instanceof UserL)) {
